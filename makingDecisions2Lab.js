...
//Code Here
let grade = score >= 90 ? 'A' : (90>score&&score>79 ? 'B' : (80>score&&score>69 ? 'C' : 'You messed up'))
console.log(grade)
// Question: It produces 'you messed up', why?
...
//Code Here
for (let i = letters.length-1; 0<=i&&i<letters.length; i--){
